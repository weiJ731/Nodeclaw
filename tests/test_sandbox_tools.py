...
from nodeclaw.core.tools.sandbox_tools import (
    list_office_files,
    read_office_file,
    write_office_file,
...
from nodeclaw.core.config import OFFICE_DIR
...
class TestSandboxTools(unittest.TestCase):
    ...
    @patch('nodeclaw.core.tools.sandbox_tools.os.path.exists', return_value=True)
    @patch('nodeclaw.core.tools.sandbox_tools.os.listdir', return_value=['file1.txt', 'subdir'])
    @patch('nodeclaw.core.tools.sandbox_tools.os.path.isdir', side_effect=lambda x: x.endswith('subdir'))
    ...
    @patch('nodeclaw.core.tools.sandbox_tools.os.path.exists', return_value=False)
    ...
    @patch('nodeclaw.core.tools.sandbox_tools.subprocess.run')
