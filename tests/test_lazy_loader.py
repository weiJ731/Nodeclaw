...
from nodeclaw.core.skill_loader import load_dynamic_skills, get_skill_count, reload_skills, clear_skill_cache
...
def test_lazy_loading():
    ...
    # 创建临时测试目录
    temp_dir = tempfile.mkdtemp(prefix="nodeclaw_test_")
