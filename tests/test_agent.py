...
from nodeclaw.core.context import AgentState
...
class TestAgent(unittest.TestCase):
    ...
    @patch('nodeclaw.core.provider.get_provider')
    @patch('nodeclaw.core.skill_loader.load_dynamic_skills')
    @patch('nodeclaw.core.tools.builtins.BUILTIN_TOOLS', [])
