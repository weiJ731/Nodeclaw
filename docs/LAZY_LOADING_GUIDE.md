...
Nodeclaw 实现了**渐进式加载 + 缓存**的技能加载机制，显著提升了系统的启动速度和内存使用效率。
...
```python
from nodeclaw.core.skill_loader import load_dynamic_skills, get_skill_count
...
```python
from nodeclaw.core.skill_loader import reload_skills
...
```python
from nodeclaw.core.skill_loader import clear_skill_cache
...
```python
from nodeclaw.core.skill_loader import clear_skill_cache, reload_skills
...
```python
from nodeclaw.core.skill_loader import _lazy_loader
